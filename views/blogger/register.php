<div class='padding50px'>
    <div class='row'>
        ...
        <div class='col-md-4'>
            <center><h2> Blogger registration </h2></center>
            <br/>
            <form method="POST" action='?controller=blogger&action=register'>
                <div>
                <label for="f_name" class="col-sm-2 col-form-label" required>First name</label>
                <input type="text" name="f_name" class="form-control" id="f_name" placeholder="First name">
                
                <label for="l_name" class="col-sm-2 col-form-label" required>Last name</label>
